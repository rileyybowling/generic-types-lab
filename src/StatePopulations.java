...
public class StatePopulations {
    ...
    public static void main(String[] args) throws IOException {
        ...
        StatePair<Integer, String> stateAbbrev = null;
        StatePair<String, String> stateName = null;
        StatePair<String, Integer> statePop = null;
        for (i = 0; i < zipCodeState.size(); ++i) {
            stateAbbrev = zipCodeState.get(i);
            if (stateAbbrev.getValue1().equals(myZipCode)){
                break;
            }
        ...
        for (i = 0; i < abbrevState.size(); ++i) {
            ...
            stateName = abbrevState.get(i);
            if (stateName.getValue1().equals(stateAbbrev.getValue2())){
                break;
            }
        }
        ...
        for (i = 0; i < statePopulation.size(); ++i) {
            statePop = statePopulation.get(i);
            if (statePop.getValue1().equals(stateName.getValue2())){
                StatePair pair = new StatePair(statePop.getValue1(), statePop.getValue2());
                pair.printInfo();
            }
